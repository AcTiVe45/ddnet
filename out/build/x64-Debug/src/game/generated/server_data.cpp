...
static CDataImage x15[] = {
	...
	/* x15[6] */ {  "console_bg",  "console.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[7] */ {  "console_bar",  "console_bar.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[8] */ {  "speedup_arrow",  "editor/speed_arrow.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[9] */ {  "guibuttons",  "gui_buttons.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[10] */ {  "guiicons",  "gui_icons.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[11] */ {  "arrow",  "arrow.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[12] */ {  "audio_source",  "editor/audio_source.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[13] */ {  "strongweak",  "strong_weak.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[14] */ {  "hud",  "hud.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[15] */ {  "extras",  "extras.png",  0,  IGraphics::CTextureHandle(), },
	/* x15[16] */ {  "raceflag",  "race_flag.png",  0,  IGraphics::CTextureHandle(), },
};
...
static CDataSprite x47[] = {
	...
	/* x47[107] */ {  "hud_airjump",  &x30[9],  0,  0,  2,  2, },
	/* x47[108] */ {  "hud_airjump_empty",  &x30[9],  2,  0,  2,  2, },
	/* x47[109] */ {  "hud_solo",  &x30[9],  4,  0,  2,  2, },
	/* x47[110] */ {  "hud_collision_disabled",  &x30[9],  6,  0,  2,  2, },
	/* x47[111] */ {  "hud_endless_jump",  &x30[9],  8,  0,  2,  2, },
	/* x47[112] */ {  "hud_endless_hook",  &x30[9],  10,  0,  2,  2, },
	/* x47[113] */ {  "hud_jetpack",  &x30[9],  12,  0,  2,  2, },
	/* x47[114] */ {  "hud_freeze_bar_full_left",  &x30[9],  0,  2,  1,  1, },
	/* x47[115] */ {  "hud_freeze_bar_full",  &x30[9],  1,  2,  1,  1, },
	/* x47[116] */ {  "hud_freeze_bar_empty",  &x30[9],  2,  2,  1,  1, },
	/* x47[117] */ {  "hud_freeze_bar_empty_right",  &x30[9],  3,  2,  1,  1, },
	/* x47[118] */ {  "hud_ninja_bar_full_left",  &x30[9],  0,  3,  1,  1, },
	/* x47[119] */ {  "hud_ninja_bar_full",  &x30[9],  1,  3,  1,  1, },
	/* x47[120] */ {  "hud_ninja_bar_empty",  &x30[9],  2,  3,  1,  1, },
	/* x47[121] */ {  "hud_ninja_bar_empty_right",  &x30[9],  3,  3,  1,  1, },
	/* x47[122] */ {  "hud_hook_hit_disabled",  &x30[9],  4,  2,  2,  2, },
	/* x47[123] */ {  "hud_hammer_hit_disabled",  &x30[9],  6,  2,  2,  2, },
	/* x47[124] */ {  "hud_shotgun_hit_disabled",  &x30[9],  8,  2,  2,  2, },
	/* x47[125] */ {  "hud_grenade_hit_disabled",  &x30[9],  10,  2,  2,  2, },
	/* x47[126] */ {  "hud_laser_hit_disabled",  &x30[9],  12,  2,  2,  2, },
	/* x47[127] */ {  "hud_gun_hit_disabled",  &x30[9],  14,  2,  2,  2, },
	/* x47[128] */ {  "hud_deep_frozen",  &x30[9],  10,  4,  2,  2, },
	/* x47[129] */ {  "hud_live_frozen",  &x30[9],  12,  4,  2,  2, },
	/* x47[130] */ {  "hud_teleport_grenade",  &x30[9],  4,  4,  2,  2, },
	/* x47[131] */ {  "hud_teleport_gun",  &x30[9],  6,  4,  2,  2, },
	/* x47[132] */ {  "hud_teleport_laser",  &x30[9],  8,  4,  2,  2, },
	/* x47[133] */ {  "hud_practice_mode",  &x30[9],  4,  6,  2,  2, },
	/* x47[134] */ {  "hud_dummy_hammer",  &x30[9],  6,  6,  2,  2, },
	/* x47[135] */ {  "hud_dummy_copy",  &x30[9],  8,  6,  2,  2, },
	/* x47[136] */ {  "hud_lock_mode",  &x30[9],  10,  6,  2,  2, },
	/* x47[137] */ {  "hud_team0_mode",  &x30[9],  12,  6,  2,  2, },
	/* x47[138] */ {  "part_snowflake",  &x30[10],  0,  0,  2,  2, },
};
static CAnimKeyframe x5078[] = {
	/* x5078[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x5085[] = {
	/* x5085[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x5092[] = {
	/* x5092[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x5099 = 0;
static CAnimKeyframe *x5123 = 0;
static CAnimKeyframe x5130[] = {
	/* x5130[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5137[] = {
	/* x5137[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x5144 = 0;
static CAnimKeyframe *x5163 = 0;
static CAnimKeyframe x5170[] = {
	/* x5170[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5177[] = {
	/* x5177[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5184 = 0;
static CAnimKeyframe x5203[] = {
	/* x5203[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5210[] = {
	/* x5210[0] */ {  0.000000f,  -12.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe x5217[] = {
	/* x5217[0] */ {  0.000000f,  -8.000000f,  0.000000f,  0.100000f, },
};
static CAnimKeyframe *x5224 = 0;
static CAnimKeyframe x5248[] = {
	/* x5248[0] */ {  0.000000f,  0.000000f,  3.000000f,  0.000000f, },
};
static CAnimKeyframe x5255[] = {
	/* x5255[0] */ {  0.000000f,  12.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x5262[] = {
	/* x5262[0] */ {  0.000000f,  8.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5269 = 0;
static CAnimKeyframe x5293[] = {
	/* x5293[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5293[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5293[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5293[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5293[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5293[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5300[] = {
	/* x5300[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5300[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x5300[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5300[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5300[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5300[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x5307[] = {
	/* x5307[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x5307[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x5307[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x5307[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5307[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x5307[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x5314 = 0;
static CAnimKeyframe x5413[] = {
	/* x5413[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5413[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5413[2] */ {  0.400000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5413[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5413[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5413[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5420[] = {
	/* x5420[0] */ {  0.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5420[1] */ {  0.200000f,  6.000000f,  0.000000f,  0.000000f, },
	/* x5420[2] */ {  0.400000f,  -7.000000f,  0.000000f,  0.000000f, },
	/* x5420[3] */ {  0.600000f,  -13.000000f,  -4.500000f,  0.050000f, },
	/* x5420[4] */ {  0.800000f,  0.000000f,  -8.000000f,  -0.200000f, },
	/* x5420[5] */ {  1.000000f,  18.000000f,  -8.000000f,  -0.270000f, },
};
static CAnimKeyframe x5427[] = {
	/* x5427[0] */ {  0.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
	/* x5427[1] */ {  0.200000f,  -14.000000f,  -5.000000f,  0.100000f, },
	/* x5427[2] */ {  0.400000f,  11.000000f,  -8.000000f,  -0.300000f, },
	/* x5427[3] */ {  0.600000f,  18.000000f,  -8.000000f,  -0.270000f, },
	/* x5427[4] */ {  0.800000f,  3.000000f,  0.000000f,  0.000000f, },
	/* x5427[5] */ {  1.000000f,  -11.000000f,  -2.500000f,  0.050000f, },
};
static CAnimKeyframe *x5434 = 0;
static CAnimKeyframe x5533[] = {
	/* x5533[0] */ {  0.000000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5533[1] */ {  0.200000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5533[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5533[3] */ {  0.600000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x5533[4] */ {  0.800000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x5533[5] */ {  1.000000f,  0.000000f,  -1.000000f,  0.000000f, },
};
static CAnimKeyframe x5540[] = {
	/* x5540[0] */ {  0.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5540[1] */ {  0.200000f,  0.000000f,  -8.000000f,  0.200000f, },
	/* x5540[2] */ {  0.400000f,  13.000000f,  -4.500000f,  -0.050000f, },
	/* x5540[3] */ {  0.600000f,  7.000000f,  0.000000f,  0.000000f, },
	/* x5540[4] */ {  0.800000f,  -6.000000f,  0.000000f,  0.000000f, },
	/* x5540[5] */ {  1.000000f,  -18.000000f,  -8.000000f,  0.270000f, },
};
static CAnimKeyframe x5547[] = {
	/* x5547[0] */ {  0.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
	/* x5547[1] */ {  0.200000f,  -3.000000f,  0.000000f,  0.000000f, },
	/* x5547[2] */ {  0.400000f,  -18.000000f,  -8.000000f,  0.270000f, },
	/* x5547[3] */ {  0.600000f,  -11.000000f,  -8.000000f,  0.300000f, },
	/* x5547[4] */ {  0.800000f,  14.000000f,  -5.000000f,  -0.100000f, },
	/* x5547[5] */ {  1.000000f,  11.000000f,  -2.500000f,  -0.050000f, },
};
static CAnimKeyframe *x5554 = 0;
static CAnimKeyframe *x5653 = 0;
static CAnimKeyframe *x5660 = 0;
static CAnimKeyframe *x5667 = 0;
static CAnimKeyframe x5674[] = {
	/* x5674[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x5674[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5674[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x5674[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x5674[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x5708 = 0;
static CAnimKeyframe *x5715 = 0;
static CAnimKeyframe *x5722 = 0;
static CAnimKeyframe x5729[] = {
	/* x5729[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x5729[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x5729[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5729[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x5729[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x5729[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x78[] = {
	/* x78[0] */ {  "base",  /* x78[0].body */ {  1,x5078, },  /* x78[0].back_foot */ {  1,x5085, },  /* x78[0].front_foot */ {  1,x5092, },  /* x78[0].attach */ {  0,x5099, }, },
	/* x78[1] */ {  "idle",  /* x78[1].body */ {  0,x5123, },  /* x78[1].back_foot */ {  1,x5130, },  /* x78[1].front_foot */ {  1,x5137, },  /* x78[1].attach */ {  0,x5144, }, },
	/* x78[2] */ {  "inair",  /* x78[2].body */ {  0,x5163, },  /* x78[2].back_foot */ {  1,x5170, },  /* x78[2].front_foot */ {  1,x5177, },  /* x78[2].attach */ {  0,x5184, }, },
	/* x78[3] */ {  "sit_left",  /* x78[3].body */ {  1,x5203, },  /* x78[3].back_foot */ {  1,x5210, },  /* x78[3].front_foot */ {  1,x5217, },  /* x78[3].attach */ {  0,x5224, }, },
	/* x78[4] */ {  "sit_right",  /* x78[4].body */ {  1,x5248, },  /* x78[4].back_foot */ {  1,x5255, },  /* x78[4].front_foot */ {  1,x5262, },  /* x78[4].attach */ {  0,x5269, }, },
	/* x78[5] */ {  "walk",  /* x78[5].body */ {  6,x5293, },  /* x78[5].back_foot */ {  6,x5300, },  /* x78[5].front_foot */ {  6,x5307, },  /* x78[5].attach */ {  0,x5314, }, },
	/* x78[6] */ {  "run_left",  /* x78[6].body */ {  6,x5413, },  /* x78[6].back_foot */ {  6,x5420, },  /* x78[6].front_foot */ {  6,x5427, },  /* x78[6].attach */ {  0,x5434, }, },
	/* x78[7] */ {  "run_right",  /* x78[7].body */ {  6,x5533, },  /* x78[7].back_foot */ {  6,x5540, },  /* x78[7].front_foot */ {  6,x5547, },  /* x78[7].attach */ {  0,x5554, }, },
	/* x78[8] */ {  "hammer_swing",  /* x78[8].body */ {  0,x5653, },  /* x78[8].back_foot */ {  0,x5660, },  /* x78[8].front_foot */ {  0,x5667, },  /* x78[8].attach */ {  5,x5674, }, },
	/* x78[9] */ {  "ninja_swing",  /* x78[9].body */ {  0,x5708, },  /* x78[9].back_foot */ {  0,x5715, },  /* x78[9].front_foot */ {  0,x5722, },  /* x78[9].attach */ {  6,x5729, }, },
};
static CDataSprite* *x5894 = 0;
static CDataSprite* x6039[] = {
	&x47[29],
	&x47[30],
	&x47[31],
};
static CDataSprite* x6235[] = {
	&x47[35],
	&x47[36],
	&x47[37],
};
static CDataSprite* *x6431 = 0;
static CDataSprite* *x6576 = 0;
static CDataSprite* x6721[] = {
	&x47[52],
	&x47[53],
	&x47[54],
};
static CDataWeaponspec x1994[] = {
	/* x1994[0] */ {  "hammer",  &x47[41],  &x47[42],  &x47[43],  0,x5894,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[1] */ {  "gun",  &x47[26],  &x47[27],  &x47[28],  3,x6039,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  58.875200f,  6.000000f,  5.000000f, },
	/* x1994[2] */ {  "shotgun",  &x47[32],  &x47[33],  &x47[34],  3,x6235,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  83.312800f,  6.000000f,  5.000000f, },
	/* x1994[3] */ {  "grenade",  &x47[38],  &x47[39],  &x47[40],  0,x6431,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[4] */ {  "laser",  &x47[47],  &x47[48],  &x47[49],  0,x6576,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1994[5] */ {  "ninja",  &x47[44],  &x47[45],  &x47[46],  3,x6721,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
